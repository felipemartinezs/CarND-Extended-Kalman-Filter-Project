    ...
    */
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      float phi;
      float rhodot;
      rho =  measurement_pack.raw_measurements_[0.0];   // data: rho_measured
      phi = measurement_pack.raw_measurements_[1.0];    // data: phi_measured
      rhodot = measurement_pack.raw_measurements_[2.0]; // data: rhodot_measured
      ...
      */
      ...
      float px = measurement_pack.raw_measurements_[0.0];  // x_measured
      float py = measurement_pack.raw_measurements_[1.0];  // y_measured
      ekf_.x_(0) = px;
      ekf_.x_(1) = py;
    }
